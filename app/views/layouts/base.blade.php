    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{URL::to('/')}}"><i class="fa fa-comments"></i> <strong>MASTER </strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="{{URL::to('elements/ui-elements')}}"><i class="fa fa-desktop"></i> UI Elements</a>
                    </li>
                    <li>
                        <a href="{{URL::to('elements/chart')}}"><i class="fa fa-bar-chart-o"></i> Charts</a>
                    </li>
                    <li>
                        <a href="{{URL::to('elements/tab-panel')}}"><i class="fa fa-qrcode"></i> Tabs & Panels</a>
                    </li>
                    
                    <li>
                        <a href="{{URL::to('elements/table')}}"><i class="fa fa-table"></i> Responsive Tables</a>
                    </li>
                    <li>
                        <a href="{{URL::to('elements/form')}}"><i class="fa fa-edit"></i> Forms </a>
                    </li>
                    ...
                    <li>
                        <a href="{{URL::to('elements/empty')}}"><i class="fa fa-fw fa-file"></i> Empty Page</a>
                    </li>
                </ul>
