    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Dropouts per college
            </div>
            <div class="panel-body">
                <div id="college-yearly-dropouts"></div>
                <!--Dropdown for prompt-->
                <form action="#" method="get">
                  <div class="input-group pull-right" style="width:100px">
                    <select class="form-control" required="required" id="college-year-dropdown" name="college-year-dropdown">
                      <option value="2008" selected="selected">2008</option><option value="2009">2009</option><option value="2010">2010</option><option value="2011">2011</option>
                    </select>
                  </div>
                </form>
                <!-- end of dropdown -->
                <div id="college-yearly-dropouts-legend" class="legend"></div>
            </div>
        </div>
    </div>
</div>
